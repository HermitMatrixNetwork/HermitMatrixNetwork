...
import (
	bytes "bytes"
	fmt "fmt"
	github_com_enigmampc_SecretNetwork_x_registration_remote_attestation "github.com/HermitMatrixNetwork/HermitMatrixNetwork/x/registration/remote_attestation"
...
type RegistrationNodeInfo struct {
	Certificate   github_com_enigmampc_SecretNetwork_x_registration_remote_attestation.Certificate `protobuf:"bytes,1,opt,name=certificate,proto3,casttype=github.com/HermitMatrixNetwork/HermitMatrixNetwork/x/registration/remote_attestation.Certificate" json:"certificate,omitempty"`
