...
type RaAuthenticate struct {
	...
	Certificate github_com_enigmampc_SecretNetwork_x_registration_remote_attestation.Certificate `protobuf:"bytes,2,opt,name=certificate,proto3,casttype=github.com/HermitMatrixNetwork/HermitMatrixNetwork/x/registration/remote_attestation.Certificate" json:"ra_cert"`
}
