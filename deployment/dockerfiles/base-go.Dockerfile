...
RUN mkdir -p /go/src/github.com/HermitMatrixNetwork/HermitMatrixNetwork/go-cosmwasm/target/release/

COPY --from=build-env-rust /go/src/github.com/HermitMatrixNetwork/HermitMatrixNetwork/go-cosmwasm/target/release/libgo_cosmwasm.so /go/src/github.com/HermitMatrixNetwork/HermitMatrixNetwork/go-cosmwasm/target/release/libgo_cosmwasm.so
COPY --from=build-env-rust /go/src/github.com/HermitMatrixNetwork/HermitMatrixNetwork/go-cosmwasm/librust_cosmwasm_enclave.signed.so /go/src/github.com/HermitMatrixNetwork/HermitMatrixNetwork/go-cosmwasm/librust_cosmwasm_enclave.signed.so
COPY --from=build-env-rust /go/src/github.com/HermitMatrixNetwork/HermitMatrixNetwork/go-cosmwasm/librust_cosmwasm_query_enclave.signed.so /go/src/github.com/HermitMatrixNetwork/HermitMatrixNetwork/go-cosmwasm/librust_cosmwasm_query_enclave.signed.so
